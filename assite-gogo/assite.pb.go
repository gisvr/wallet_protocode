...
type ListCoinTxRequest struct {
	...
	BeginBlockTime bitbucket_org_biiigle_biiigle_wa001_dams_src_lib_time.Time `protobuf:"varint,14,opt,name=BeginBlockTime,proto3,casttype=github.com/gisvr/golib/time.Time" json:"begin_block_time" gorm:"type:datetime;"`
	//cointx.BlockTime < EndBlockTime
	EndBlockTime bitbucket_org_biiigle_biiigle_wa001_dams_src_lib_time.Time `protobuf:"varint,15,opt,name=EndBlockTime,proto3,casttype=github.com/gisvr/golib/time.Time" json:"end_block_time" gorm:"type:datetime;"`
	//充值提现
